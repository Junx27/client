      ...
      <div className="row">
        <div className="col-8 ms-5 pt-3">
          ...
          <p className="text-muted text-end shadow pe-2">
            <span className="orange">Mastered Abilities:</span> Fresh Graduated
            | Web Developer | Design | More
            <hr />
          </p>
          ...
          <div className="shadow mt-5 border-bottom border-warning border-2 grow">
            ...
            <p className="ms-3">
              ...
              totam earum possimus amet. Velit tempore aut nostrum consequuntur
              quam aspernatur inventore!
            </p>
